...
class ResidualBlock(keras.layers.Layer):
    def __init__(self, filters=192, c=0.00001):
        super().__init__()
        ...
        self.batch_n1 = layers.BatchNormalization(momentum=0.925)
        self.batch_n2 = layers.BatchNormalization(momentum=0.925)
...
class PolicyBlock(keras.layers.Layer):
    def __init__(self, columns=7, filters=32, hidden_units=256, c=0.00001):
        super().__init__()
...
class ValueBlock(keras.layers.Layer):
    def __init__(self, filters=32, hidden_units=256, c=0.00001):
        super().__init__()
